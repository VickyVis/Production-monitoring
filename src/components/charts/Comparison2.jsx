...
export default class Comparison2 extends PureComponent {


  render() {
    return (
      <div className='w-[690px] h-[350px] pt-4'>
      <ResponsiveContainer width="100%" height="100%">
        ...
        >
          ...
          <Bar dataKey="production_7D" fill="#82ca9d" activeBar={<Rectangle fill="gold" stroke="purple" />} />
        </BarChart>
      </ResponsiveContainer>
      </div>
    );
